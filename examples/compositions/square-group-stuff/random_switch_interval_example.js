...
exports.create = function(zAnimator){
  ...
  var squares = [];
  for(var i = 0; i < 100; i++){
    var square = zAnimator.factory.image({ source: 'resources/test.png'});
    //var square = zAnimator.factory.square({squareShape: zAnimator.geometry.shapes.square({sidelength: 5}), color: '#000'});
    squares.push(square);
  }
  var rectangleGroupInterval = zAnimator.compositions.squareGroupStuff.randomSquareSwitchInterval({interval: 100, spacing: 60, children: squares, columns: 10, visible: 95});
